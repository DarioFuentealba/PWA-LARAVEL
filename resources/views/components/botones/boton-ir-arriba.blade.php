...
>
    <!-- Imagen del boton -->
    <img src="{{ asset('images/botonIrArriba/tridenteChico.png') }}" alt="Ir arriba" class="w-12 h-12 object-contain mt-1 hover:drop-shadow-[0_0_8px_#6e1414]"
    />

    <!-- Texto dentro del circulo -->
    <span class="text-[10px] mb-1 hover:drop-shadow-[0_0_8px_#6e1414]">Ir arriba</span>
</button>
